...
static void recursive_triangulation (Polygon &, std::list<Triangle> &);


void triangulate (const Polygon & input_P, std::list<Triangle> & output)
{
...
static void recursive_triangulation (Polygon & P, std::list<Triangle> & output)
{

...
void WiseEmptySensorManager::processSampleRequest(WiseSensorManagerMessage *req) {
    ...
    smp = new WiseEmptySensorMessage("Empty Random reading",
...
void WiseEmptySensorManager::handleSample(WisePhysicalProcessMessage *msg) {
}

void WiseEmptySensorManager::processCommandRequest(

\begin{figure}
\centering
\caption{Latency for control packet transmissions and number of hops.}
\begin{tikzpicture}
    \begin{axis}[
        ylabel={Time [ms]},
        ...
        xtick=data,
        xticklabels from table={\simcsvdicLatencyControl}{NumberOfNodes},
